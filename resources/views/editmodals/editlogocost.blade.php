        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-6 mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm" wire:model="text">
                </div>
                <div class="col-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control form-control-sm" wire:model="editLogos.{{ $index }}.height">
                </div>
                <div class="col-md-6 mb-3">
