                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div>
                            ...
                            <div class="col-4">
                                <div class="mt-1 ms-4">
                                    <input type="text"
                                        class="form-control form-control-sm" wire:model="mainCost.{{ $index }}.acrylicInput">
                                </div>
                            </div>
                            @endif
                        </div>
                            ...
                            <div class="col-4">
                                <div class="mt-1 ms-4">
                                    <input type="text"
                                        ...
                                        wire:model="mainCost.{{ $index }}.blackAcrylicInputs.{{ $size }}">
                                </div>
                            </div>
                            @endif
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div>
                            ...
                            <div class="col-4">
                                ...
                                <div class="mt-1 ms-4">
                                    <input type="text" class="form-control form-control-sm"
                                        wire:model="mainCost.{{ $index }}.pvcInputs">
                                </div>
                            </div>
                            @endif
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div>
                            ...
                            <div class="mt-1 ms-4">
                                <div class="col-4">
                                    <input type="text" class="form-control form-control-sm"
                                        wire:model="mainCost.{{ $index }}.stainlessteelsilverInputs">
                                </div>
                            </div>
                            @endif
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div>
                            ...
                            <div class="mt-1 ms-4">
                                <div class="col-4">
                                    <input type="text" class="form-control form-control-sm"
                                        wire:model="mainCost.{{ $index }}.stainlessteelgoldInputs">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check">
                            ...
                            <div class="mt-1 ms-4">
                                <div class="col-4">
                                    <input type="text" class="form-control form-control-sm"
                                        wire:model="mainCost.{{ $index }}.NeonmaterialInputs">
                                </div>
                            </div>
                            @endif
                        </div>
                    ...
                    <div class="col-md-3" x-data="{ enabled: @entangle('ownCost.' . $index . '.ownStickerHeightWidth') }">
                        ...
                        <div>
                            ...
                            <div class="mt-1 ms-4 col-4">
                                <input type="text" class="form-control form-control-sm"
                                    wire:model="mainCost.{{ $index }}.stickermaterialInputs.{{ $val }}">
                            </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div>
                            ...
                            <div class="mt-1 ms-4 col-4">
                                <input type="text" class="form-control form-control-sm"
                                    wire:model="mainCost.{{ $index }}.generalMaterialInputs.{{ $key }}">
                            </div>
                            @endif
                        </div>
                        @endforeach
