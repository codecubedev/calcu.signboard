            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div>
                        ...
                        <div class="col-4">
                            <div class="mt-1 ms-4">
                                <input type="text"
                                    class="form-control form-control-sm" wire:model="ownCost.{{ $index }}.acrylicInput">
                            </div>
                        </div>
                        @endif
                    </div>
                        ...
                        <div class="col-4">
                            <div class="mt-1 ms-4">
                                <input type="text"
                                    ...
                                    wire:model="ownCost.{{ $index }}.blackAcrylicInputs.{{ $size }}">
                            </div>
                        </div>
                        @endif
                    </div>
                ...
                <div class="col-md-3">
                    ...
                    <div>
                        ...
                        <div class="mt-1 ms-4">
                            <div class="col-4">
                                <input type="text" class="form-control form-control-sm"
                                    wire:model="ownCost.{{ $index }}.stainlessteelsilverInputs.{{ $key }}">
                            </div>
                        </div>
                        @endif
                    </div>
                ...
                <div class="col-md-3" x-data="{ enabled: @entangle('ownCost.' . $index . '.ownStickerHeightWidth') }">
                    ...
                    <div>
                        ...
                        <div class="mt-1 ms-4 col-4">
                            <input type="text" class="form-control form-control-sm"
                                wire:model="ownCost.{{ $index }}.stickermaterialInputs.{{ $val }}">
                        </div>
                        @endif
                    </div>
                    @endforeach
                ...
                <div class="col-md-3">
                    ...
                    <div>
                        ...
                        <div class="mt-1 ms-4 col-4">
                            <input type="text" class="form-control form-control-sm"
                                wire:model="ownCost.{{ $index }}.generalMaterialInputs.{{ $value }}">
                        </div>
                        @endif
                    </div>
                    @endforeach
                ...
                <div class="col-md-3">
                    ...
                    <div>
                        ...
                        <div class="mt-1 ms-4 col-4">
                            <input type="text"
                                class="form-control form-control-sm"
                                wire:model="ownCost.{{ $index }}.ownOracalInputs.oracal">
                        </div>
                        @endif
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div>
                        ...
                        <div class="mt-1 ms-4 col-4">
                            <input type="text"
                                class="form-control form-control-sm"
                                wire:model="ownCost.{{ $index }}.addLightingInputs.{{ $type }}">
                        </div>
                        @endif
                    </div>
                    @endforeach
