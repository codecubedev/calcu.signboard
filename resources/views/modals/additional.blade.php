                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div>
                            ...
                            <div class="col-4">
                                <div class="mt-1 ms-4">
                                    <input type="text"
                                        class="form-control form-control-sm" wire:model="addCost.{{ $index }}.acrylicInput">
                                </div>
                            </div>
                            @endif
                        </div>
                            ...
                            <div class="col-4">
                                <div class="mt-1 ms-4">
                                    <input type="text"
                                        ...
                                        wire:model="addCost.{{ $index }}.blackAcrylicInputs.{{ $size }}">
                                </div>
                            </div>
                            @endif
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div>
                            ...
                            <div class="col-4">
                                ...
                                <div class="mt-1 ms-4">
                                    <input type="text" class="form-control form-control-sm"
                                        wire:model="addCost.{{ $index }}.pvcInputs">
                                </div>
                            </div>
                            @endif
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check mb-1">
                            ...
                            <div class="mt-1 ms-4">
                                <div class="col-4">
                                    <input type="text" class="form-control form-control-sm"
                                        wire:model="addCost.{{ $index }}.stainlessteelsilverInputs.{{ $key }}">
                                </div>
                            </div>
                            @endif
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check mb-1">
                            ...
                            <div class="mt-1 ms-4">
                                <div class="col-4">
                                    <input type="text" class="form-control form-control-sm"
                                        wire:model="addCost.{{ $index }}.stainlessteelgoldInputs">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check">
                            ...
                            <div class="mt-1 ms-4">
                                <div class="col-4">
                                    <input type="text" class="form-control form-control-sm"
                                        wire:model="addCost.{{ $index }}.NeonmaterialInputs">
                                </div>
                            </div>
                            @endif
                        </div>
                    ...
                    <div class="col-md-3" x-data="{ enabled: @entangle('ownCost.' . $index . '.ownStickerHeightWidth') }">
                        ...
                        <div>
                            ...
                            <div class="mt-1 ms-4 col-4">
                                <input type="text" class="form-control form-control-sm"
                                    wire:model="addCost.{{ $index }}.stickermaterialInputs.{{ $val }}">
                            </div>
                            @endif
                        </div>
                        @endforeach
                    ...
                    <div class="col-md-3">
                        ...
                        <div>
                            ...
                            <div class="mt-1 ms-4 col-4">
                                <input type="text" class="form-control form-control-sm"
                                    wire:model="addCost.{{ $index }}.generalMaterialInputs.{{ $key }}">
                            </div>
                            @endif
                        </div>
                        @endforeach
                    ...
                    <div class="col-md-4">
                        ...
                        <div>
                            ...
                            <div class="mt-1 ms-4 col-4">
                                <input type="text"
                                    class="form-control form-control-sm"
                                    wire:model="addCost.{{ $index }}.addOracalInputs.{{ $key }}">
                            </div>
                            @endif
                        </div>
                ...
                <div class="col-4">
                    ...
                    <div>
                        ...
                        <div class="mt-1 ms-4 col-4">
                            <input type="text"
                                class="form-control form-control-sm"
                                wire:model="addCost.{{ $index }}.addLightingInputs.{{ $type }}">
                        </div>
                        @endif
                    </div>
                    @endforeach
