                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="mb-1">
                            ...
                            <div class="col-4">
                                <div class="mt-1 ms-4">
                                    <input type="text"
                                        class="form-control form-control-sm" wire:model="logoCost.{{ $index }}.acrylicInput">
                                </div>
                            </div>
                            @endif
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mb-1">
                            ...
                            <div class="mt-1 ms-4 col-4">
                                <input type="text" class="form-control form-control-sm"
                                    wire:model="logoCost.{{ $index }}.generalMaterialInputs">
                            </div>
                            @endif
                        </div>
                        @endforeach
                    ...
                    <div class="col-md-3">
                        ...
                        <div>
                            <input type="checkbox" class="form-check-input"
                                wire:model="logoCost.{{ $index }}.logoPaintHeightWidth" wire:change="togglepaintMaterialInput({{ $index }}, '{{ $val }}')">
                            <label>Paint</label>
                            @if (!empty($logoCost[$index]['showGeneralInputs']) && in_array($val, $logoCost[$index]['showGeneralInputs']))
                            <div class="mt-1 ms-4 col-4">
                                <input type="text" class="form-control form-control-sm"
                        ...
                        <div>
                            ...
                            <div class="mt-1 ms-4 col-4">
                                <input type="text"
                                    ...
                                    wire:model="logoCost.{{ $index }}.logoOracalInputs.oracal">
                            </div>
                            @endif
                        </div>
                ...
                <div class="col-4">
                    ...
                    <div>
                        <input type="checkbox"
                            ...
                            value="{{ $type }}"
                            wire:change="toggleLightingInput({{ $index }}, '{{ $type }}')">

                        <label>{{ ucfirst($type) }}</label>

                        @if (!empty($logoCost[$index]['showLightingInputs'])
                        && in_array($type, $logoCost[$index]['showLightingInputs']))
                        <div class="mt-1 ms-4 col-4">
                            <input type="text"
                                class="form-control form-control-sm"
                                wire:model="logoCost.{{ $index }}.logoLightingInputs.{{ $type }}">
                        </div>
                        @endif
                    </div>
                    @endforeach
