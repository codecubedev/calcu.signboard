    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    <label>Neon</label>
                    <select class="form-select form-select-sm" wire:model="mainNeonSize">
                        <option value="">-- Select Size --</option>
                        <option value="5">5MM Clear Acrylic</option>
                        <option value="10">10MM Clear Acrylic</option>
                    </select>
                    @if(!empty($mainNeonSize))
                ...
                <div class="col-md-3 mt-3">
                    ...
                    <div class="mb-3">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" wire:model="mainPaint"> Paint
                        </label>
                    ...
                    <div class="mb-3">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" wire:model="mainOracal"> Oracal
                        </label>
                    ...
                    <div class="mb-3">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" wire:model="mainIronHollow10mm"> Iron Hollow 10 MM
                        </label>

                        @if(!empty($mainIronHollow10mm))
                        <input type="text" class="form-control form-control-sm mt-2"
                            placeholder="Enter Cost"
                            wire:model="mainIronHollow10mmCost">
                        @endif
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" wire:model="mainIronHollow20mm"> Iron Hollow 20 MM
                        </label>

                        @if(!empty($mainIronHollow20mm))
                        <input type="text" class="form-control form-control-sm mt-2"
                            placeholder="Enter Cost"
                            wire:model="mainIronHollow20mmCost">
                        @endif
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" wire:model="mainSpotlight"> Spotlight + Bracket (1 set)
                        </label>

                        @if(!empty($mainSpotlight))
                        <input type="text" class="form-control form-control-sm mt-2"
                            placeholder="Enter Cost"
                            wire:model="mainSpotlightCost">
                        @endif
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" wire:model="mainDimmer"> Dimmer
                        </label>

                        @if(!empty($mainDimmer))
                        <input type="text" class="form-control form-control-sm mt-2"
                            placeholder="Enter Cost"
                            wire:model="mainDimmerCost">
                        @endif
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" wire:model="mainLighting"> Lighting
                        </label>
